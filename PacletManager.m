...
`Information`$CreationID = If[SyntaxQ["20151227203014"], ToExpression["20151227203014"], 0]
`Information`$CreationDate = If[SyntaxQ["{2015,12,27,20,30,14}"], ToExpression["{2015,12,27,20,30,14}"], {0,0,0,0,0,0}]
