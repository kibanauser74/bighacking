...
$searchLanguage = If[StringQ[#], #, $Language]& @ Quiet[CurrentValue[$FrontEnd, "Language"]]
    ...
    Module[{trimmedURL, resource, resourceWithoutFragment, wordsOnly, fallThroughToSearch,
        ...
        *)
        If[!$hasCheckedForFallbackNonEnglishLang,
            ...
            If[Length[langDirs] > 0 && !MemberQ[langDirs, $searchLanguage],
                $searchLanguage = First[langDirs]
            ]
        ];
    ...
    Module[{encodedQuery, nb},
        ...
        Switch[type,
            ...
            "InstalledPacletsAndAddOns",
                ...
                nb = Documentation`MakeInstalledAddOnsNotebook[getInstalledPacletsAndAddOns[], True],
            "About",
...
loadDocSearchPackage[] := 
    If[!$hasLoadedDocSearch,
        ...
        Block[{$ContextPath = {"System`"}}, Evaluate[Symbol["DocumentationSearch`$SearchLanguage"]] = $searchLanguage; Needs["DocumentationSearch`"]]
    ]
...
*)
getInstalledPacletsAndAddOns[] :=
    Module[{appLocations, appDirs, pacletDirs, appLinks, paclets, userPacletInformation},
        ...
        pacletDirs = Select[appDirs, FileNames[{"PacletInfo.m", "PacletInfo.wl"}, #] =!= {} &];
        ...
        *) 
        ...
        (*  Now merge appLinks and userPacletInformation into a single list. *)
        appLinks = {"Name" -> #1, "URI" -> #2, "Paclet" -> False}& @@@ appLinks;
        ...
        (* Join and sort by name in alphabetical order. *)
        SortBy[Join[userPacletInformation, appLinks], First]
    ]
